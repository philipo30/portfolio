...
<Table
  data={{
    ...
    rows: [
      ...
      ["Upload Limit", "100MB", "50MB"],
      ["HD Video Streaming", "Yes", "Yes"],
...
### 6. **Global Chat Effects**
Add flair to your messages with **global chat effects** like confetti or fireworks. These effects make your messages pop and add a touch of fun to conversations.
...
<Callout emoji="🎮">
  Fun Fact: Many streamers and content creators use Discord Nitro to enhance their community interactions and stand out in the gaming world.
</Callout>
...
1. Open Discord and click on your profile picture.
2. Select **Nitro** from the menu.
3. Choose between **Nitro** or **Nitro Classic**.
4. Complete the payment process.

<Callout emoji="💳">
  Pro Tip: Discord often offers discounts for annual subscriptions, so keep an eye out for deals!
</Callout>
...
<Callout emoji="🎉">
  Ready to take your Discord experience to the next level? Try Discord Nitro today and see the difference for yourself!
</Callout>
