...
Start by [deploying](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fphilipo30%2Fportfolio) your portfolio with Vercel in minutes, or fork the [repository](https://github.com/philipo30/portfolio) and follow the instructions below to set it up.
...
export const metaData = {
  baseUrl: "https://philip30.vercel.app", // Update with your site base URL
  title: "Philip30", // Update with your site title
  name: "Philip", // Update with your name
...
export const socialLinks = {
  ...
  github: "https://github.com/philipo30/portfolio", // Update with your GitHub URL
